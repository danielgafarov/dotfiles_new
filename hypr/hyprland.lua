...
local permission = "/usr/bin/hyprpm, plugin, allow"
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(DA5BCEff)", "rgba(1E015Eff)"}, angle = 45 },
...
hl.bind(mainMod .. " + I", hl.dsp.exec_cmd("hyprctl keyword monitor 'eDP-1, disable'"))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(browser))
--hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("~/.config/hypr/change_to_light_theme.sh"))
--hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("~/.config/hypr/change_to_dark_theme.sh"))
